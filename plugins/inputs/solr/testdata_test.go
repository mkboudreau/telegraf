  ...
  "solr-mbeans": [
    ...
    "QUERYHANDLER",
    {
      ...
      "/dataimport": {
        ...
        "stats": {
          "Status": "IDLE",
          "Documents Processed": "java.util.concurrent.atomic.AtomicLong:0",
          "Requests made to DataSource": "java.util.concurrent.atomic.AtomicLong:1",
          "Rows Fetched": "java.util.concurrent.atomic.AtomicLong:0",
          "Documents Deleted": "java.util.concurrent.atomic.AtomicLong:0",
          "Documents Skipped": "java.util.concurrent.atomic.AtomicLong:0",
          "Total Documents Processed": "java.util.concurrent.atomic.AtomicLong:1",
          "Total Requests made to DataSource": "java.util.concurrent.atomic.AtomicLong:12",
          "Total Rows Fetched": "java.util.concurrent.atomic.AtomicLong:3",
          ...
          "timeouts": 0,
          "totalTime": 22.981686,
          "avgRequestsPerSecond": 2.081172260159925e-05,
          "5minRateRequestsPerSecond": 0,
          "15minRateRequestsPerSecond": 0,
          "avgTimePerRequest": 5.1738995914926935,
          "medianRequestTime": 0.548301,
          "75thPcRequestTime": 3.013053,
          "95thPcRequestTime": 19.329738,
          "99thPcRequestTime": 19.329738,
          "999thPcRequestTime": 19.329738
        }
      },
      "/admin/logging": {
        "stats": {
...
var solrDataImportHandlerExpected = map[string]interface{}{
	"dih_status":                    "IDLE",
	"dih_is_idle":                   int8(1),
	"dih_is_running":                int8(0),
	"dih_docs_processed":            int64(0),
	"dih_datasource_requests":       int64(1),
	"dih_rows_fetched":              int64(0),
	"dih_docs_deleted":              int64(0),
	"dih_docs_skipped":              int64(0),
	"dih_total_docs_processed":      int64(1),
	"dih_total_datasource_requests": int64(12),
	"dih_total_rows_fetched":        int64(3),
	"dih_total_docs_deleted":        int64(0),
	"dih_total_docs_skipped":        int64(0),
	"handler_start":                 int64(1516040508127),
	"requests":                      int64(4),
	"errors":                        int64(0),
	"timeouts":                      int64(0),
	"total_time":                    float64(22.981686),
	"avg_requests_per_second":       float64(2.081172260159925e-05),
	"5min_rate_reqs_per_second":     float64(0),
	"15min_rate_reqs_per_second":    float64(0),
	"avg_time_per_request":          float64(5.1738995914926935),
	"median_request_time":           float64(0.548301),
	"75th_pc_request_time":          float64(3.013053),
	"95th_pc_request_time":          float64(19.329738),
	"99th_pc_request_time":          float64(19.329738),
	"999th_pc_request_time":         float64(19.329738),
}
