...
var solr3DataImportHandlerExpected = map[string]interface{}{
	"dih_status":                    "IDLE",
	"dih_is_idle":                   int8(1),
	"dih_is_running":                int8(0),
	"dih_docs_processed":            int64(1),
	"dih_datasource_requests":       int64(2),
	"dih_rows_fetched":              int64(2),
	"dih_docs_deleted":              int64(0),
	"dih_docs_skipped":              int64(0),
	"dih_total_docs_processed":      int64(351705),
	"dih_total_datasource_requests": int64(1438),
	"dih_total_rows_fetched":        int64(876393),
	"dih_total_docs_deleted":        int64(0),
	"dih_total_docs_skipped":        int64(0),
	"handler_start":                 int64(1516083353155),
	"requests":                      int64(2442),
	"errors":                        int64(0),
	"timeouts":                      int64(0),
	"total_time":                    float64(1748),
	"avg_requests_per_second":       float64(0.017792022),
	"5min_rate_reqs_per_second":     float64(0),
	"15min_rate_reqs_per_second":    float64(0),
	"avg_time_per_request":          float64(0.7158067),
	"median_request_time":           float64(0),
	"75th_pc_request_time":          float64(0),
	"95th_pc_request_time":          float64(0),
	"99th_pc_request_time":          float64(0),
